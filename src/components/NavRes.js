...
class ResAppBar extends Component{
  ...
  destroyDrawer(){
    ...
    return (
      <AppBar>
        <Toolbar>
          <Typography variant = "headline" style={{flexGrow:1}} color="inherit" >ResumeHacker</Typography>
          <Typography variant = "subheading" className = {classes.padding} color="inherit" >Dashboard</Typography>
          <Typography variant = "subheading" className = {classes.padding} color="inherit" >Account</Typography>
